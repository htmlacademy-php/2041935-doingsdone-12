...
$category = array('Входящие', 'Учеба', 'Работа', 'Домашние дела', 'Авто');
$tasks = [
    ["Собеседование в IT-компании", "01.12.2019", "Работа", false],
    ["Выполнить тестовое задание", "25.12.2019", "Работа", false],
    ["Сделать задание первого раздела", "25.12.2019", "Учеба", true],
            ...
            <main class="content__main">
                ...
                <table class="tasks">
                    <?php foreach ($tasks as $value) : ?>
                        <?php if ($show_complete_tasks == 0 && $value[3] == true) {
                            continue;
                        } ?>
                        <tr class="tasks__item task <?= ($value[3] == true) ? 'task--completed' : ''; ?>">
